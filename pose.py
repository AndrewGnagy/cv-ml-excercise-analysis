...
#A class with magic math from https://github.com/kr1210/Human-Pose-Compare/
class Pose(object):
	...
	#Uses pose to find positional data
	#Returns a 1x34 matrix and an image
	...
	#re-calculates coordinates relative to region of interest
